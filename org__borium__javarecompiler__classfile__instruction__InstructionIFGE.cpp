...
namespace org::borium::javarecompiler::classfile::instruction
{
	...
	Pointer<Class> InstructionIFGE::__thisClassStatic;

	void InstructionIFGE::__ClassInit()
	{
		...
		__thisClassStatic = new Class(
			"org::borium::javarecompiler::classfile::instruction::InstructionIFGE",
	...
	InstructionIFGE::InstructionIFGE(Pointer<ByteInputStream> in) :
	...
	int InstructionIFGE::getStackDepthChange()
	{
