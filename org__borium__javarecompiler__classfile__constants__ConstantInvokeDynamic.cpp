...
namespace org::borium::javarecompiler::classfile::constants
{
	...
	Pointer<Class> ConstantInvokeDynamic::__thisClassStatic;

	void ConstantInvokeDynamic::__ClassInit()
	{
		...
		__thisClassStatic = new Class(
			"org::borium::javarecompiler::classfile::constants::ConstantInvokeDynamic",
