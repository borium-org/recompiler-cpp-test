...
namespace org::borium::javarecompiler::classfile::attribute
{
	...
	Pointer<Class> AttributeInnerClasses::__thisClassStatic;

	void AttributeInnerClasses::__ClassInit()
	{
		...
		__thisClassStatic = new Class(
			"org::borium::javarecompiler::classfile::attribute::AttributeInnerClasses",
	...
	AttributeInnerClasses::AttributeInnerClasses(Pointer<ClassAttribute> attribute, Pointer<ConstantPool> cp) :
	...
	void AttributeInnerClasses::detailedDump(Pointer<IndentedOutputStream> stream)
	{
		...
		temp_0007 = new StringBuilder(createString("Inner classes: "));
	...
	L0022: //
		...
		stream->iprintln(temp_002B->append(createString(":"))->toString());
		this->classTable->get(i_001F)->detailedDump(stream);
		i_001F += 1;
	L0046: //
	...
	void AttributeInnerClasses::decode(Pointer<ConstantPool> cp)
	{
		...
		Pointer<JavaArray<InnerClass>> temp_0013;
		Pointer<InnerClass> temp_002B;
		temp_0008 = new ByteInputStream(this->info);
		in_000C = temp_0008;
		numberOfClasses_0011 = in_000C->u2();
		temp_0013 = new JavaArray<InnerClass>(numberOfClasses_0011);
		this->classTable = temp_0013;
		i_001C = 0;
		goto L0032;
	L001F: //
		temp_002B = new InnerClass(in_000C, cp);
		this->classTable->assign(i_001C, temp_002B);
		i_001C += 1;
	L0032: //
		if ((i_001C) < (numberOfClasses_0011))
			goto L001F;
		in_000C->close();
		return;
	}
