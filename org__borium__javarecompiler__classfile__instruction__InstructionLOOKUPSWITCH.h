...
namespace org::borium::javarecompiler::classfile::instruction
{
	...
	class InstructionLOOKUPSWITCH : public Instruction
	{
	public:
	...
	public:
		int padding;
		int defaultLabel;
		Pointer<JavaRawArray<int>> match;
		Pointer<JavaRawArray<int>> offset;

		static void __ClassInit();
		InstructionLOOKUPSWITCH(Pointer<ByteInputStream> in);
		...
		virtual int getMatch(int index);
