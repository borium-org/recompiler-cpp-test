...
namespace org::borium::javarecompiler::classfile::instruction
{
	...
	Pointer<Class> InstructionINVOKEVIRTUAL::__thisClassStatic;

	void InstructionINVOKEVIRTUAL::__ClassInit()
	{
		...
		__thisClassStatic = new Class(
			"org::borium::javarecompiler::classfile::instruction::InstructionINVOKEVIRTUAL",
			org::borium::javarecompiler::classfile::instruction::Instruction::__thisClassStatic);

		org::borium::javarecompiler::classfile::instruction::Instruction::__ClassInit();
	}

	InstructionINVOKEVIRTUAL::InstructionINVOKEVIRTUAL(Pointer<ByteInputStream> in, Pointer<ConstantPool> cp) :
		Instruction() //
		, index(0) //
	{
		__ClassInit();
	...
	void InstructionINVOKEVIRTUAL::detailedDump(Pointer<IndentedOutputStream> stream)
	{
	...
	Pointer<String> InstructionINVOKEVIRTUAL::getMethodClassName()
	{
		UsageCounterMaintainer maintainer(this, true);
	...
	Pointer<String> InstructionINVOKEVIRTUAL::getmethodDescriptor()
	{
		UsageCounterMaintainer maintainer(this, true);
	...
	Pointer<String> InstructionINVOKEVIRTUAL::getMethodName()
	{
		UsageCounterMaintainer maintainer(this, true);
	...
	int InstructionINVOKEVIRTUAL::getStackDepthChange()
	{
		UsageCounterMaintainer maintainer(this, true);
	...
	int InstructionINVOKEVIRTUAL::length()
	{
		UsageCounterMaintainer maintainer(this, true);
