...
namespace org::borium::javarecompiler::classfile::instruction
{
	...
	Pointer<Class> InstructionDUP2_X2::__thisClassStatic;

	void InstructionDUP2_X2::__ClassInit()
	{
		...
		__thisClassStatic = new Class(
			"org::borium::javarecompiler::classfile::instruction::InstructionDUP2_X2",
			org::borium::javarecompiler::classfile::instruction::Instruction::__thisClassStatic);

		org::borium::javarecompiler::classfile::instruction::Instruction::__ClassInit();
	}

	InstructionDUP2_X2::InstructionDUP2_X2() :
		Instruction() //
	{
		__ClassInit();
	...
	int InstructionDUP2_X2::getStackDepthChange()
	{
